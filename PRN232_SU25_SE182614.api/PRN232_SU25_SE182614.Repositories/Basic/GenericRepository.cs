...
namespace PRN232_SU25_SE182614.Repositories.Basic
{
    public class GenericRepository<T> where T : class
    {
        protected HandbagDbContext _context;

        public GenericRepository()
        {
            _context ??= new HandbagDbContext();
        }

        public GenericRepository(HandbagDbContext context)
        {
            _context = context;
        }
